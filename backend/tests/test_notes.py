...
class TestVisitNoteAPI:
    ...
    def test_create_visit_note_requires_auth(self):
        """メモ作成には認証が必要"""
    ...
    def test_create_visit_note_success(self):
        """認証済みユーザーはメモを作成できる"""
    ...
    def test_update_visit_note_requires_auth(self):
        """メモ更新には認証が必要"""
        response = client.put(
    ...
    def test_delete_visit_note_requires_auth(self):
        """メモ削除には認証が必要"""
...
class TestVisitSetNoteAPI:
    ...
    def test_create_visit_set_note_requires_auth(self):
        """シーケンスメモ作成には認証が必要"""
        response = client.post(
    ...
    def test_update_visit_set_note_requires_auth(self):
        """シーケンスメモ更新には認証が必要"""
        response = client.put(
    ...
    def test_delete_visit_set_note_requires_auth(self):
        """シーケンスメモ削除には認証が必要"""
