...
class pfs_visit(Base):
    ...
    agc_exposure = relation('agc_exposure', uselist=False, back_populates='pfs_visit')
...
class agc_exposure(Base):
    ...
    pfs_visit_id = Column(Integer, ForeignKey('pfs_visit.pfs_visit_id'), comment='PFS visit identifier', unique=True)
